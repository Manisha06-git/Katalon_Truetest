...
"Step 4: Click on link 'TI line of credit status' -> Navigate to page 'tisloc/web/status-utilization/en-us/view'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Verify Access and Status View of Ti Line of Credit_visual_checkpoint')
