...
"Step 3: Click on link 'Checkout profiles' -> Navigate to page 'checkoutprofile/web/checkoutprofiles'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Verify Checkout Profiles Display_visual_checkpoint')
