...
"Step 6: Click on atomic 'headerSearchBox' -> Navigate to page 'sitesearch/en-us/docs/universalsearch.tsp'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_product/atomic_headersearchbox'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
"Step 8: Click on atomic  -> Navigate to page 'product/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Tax Profile Setup and Configuration_visual_checkpoint')
