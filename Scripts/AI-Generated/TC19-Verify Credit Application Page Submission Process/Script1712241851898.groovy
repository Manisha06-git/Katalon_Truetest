...
"Step 3: Click on ti  -> Navigate to page 'tisloc/web/credit-application/en-us/apply'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Verify Credit Application Page Submission Process_visual_checkpoint')
