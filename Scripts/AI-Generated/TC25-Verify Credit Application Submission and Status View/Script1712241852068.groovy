...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_tisloc_web_status_utilization_en_us_view/div_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/tisloc/web/status-utilization/en-us/view?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_tisloc_web_status_utilization_en_us_view/div_object'))
...
"Step 6: Click on ti  -> Navigate to page 'tisloc/web/credit-application/en-us/apply'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC25-Verify Credit Application Submission and Status View_visual_checkpoint')
